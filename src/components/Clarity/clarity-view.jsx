  ...
  return (
    <Grid item sx={12} sm={6} md={4} display="flex" justifyContent="center">
      <Paper elevation={0} sx={{ p: 3, backgroundColor: 'whitesmoke', display: 'flex', flexDirection: 'column', alignItems: 'center', width: '70vw' }}>
        ...
        <Typography component="h3" aria-label={`${header}`} variant="h5" sx={{ fontWeight: 700, color: theme.palette.text.secondary, textAlign: 'center' }}>
          {header}
        </Typography>
...
function Clarity() {
  ...
  return (
    <Box>
      ...
      <Paper elevation={0} sx={{backgroundColor: 'whitesmoke', minHeight: '50vh', display: 'flex', textAlign: 'center', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', paddingBottom: {xs: '5px', md: 10}}}>
          <Typography component="h3" variant={isMd ? 'h3' : 'h4'} sx={{margin: '20px', color: theme.clarity.secondary, fontWeight: 700 }}>
            Why Clarity?
          </Typography>
