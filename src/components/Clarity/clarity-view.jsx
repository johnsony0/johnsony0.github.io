  ...
  return (
    <Grid item sx={12} sm={6} md={4} display="flex" justifyContent="center">
      <Paper elevation={0} sx={{ p: 3, backgroundColor: 'whitesmoke', display: 'flex', flexDirection: 'column', alignItems: 'center', width: '70vw' }}>
        ...
        <Typography component="h3" aria-label={`${header}`} variant="h5" sx={{ fontWeight: 600, color: theme.palette.text.secondary, textAlign: 'center' }}>
          {header}
        </Typography>
        <Typography variant="subtitle1" sx={{ fontWeight: 400, color: theme.palette.text.primary, textAlign: 'center' }}>
          {text}
        </Typography>
      </Paper>
    </Grid>
...
function Clarity() {
  ...
  return (
    <Box>
      ...
      <Box container sx={{ display: 'flex', minHeight: '77vh', justifyContent: 'center', alignItems:'center',  flexDirection: {xs: 'column', md:'row'}, backgroundImage: 'linear-gradient(to bottom, #f5f5dc, #f5f5f5)'}}>
        ...
        <Box sx={{ display: 'flex',  flexDirection:'column', textAlign: {xs: 'center', md:'start'} }}>
          ...
          <Typography component="h1" variant={isMd ? 'h3' : 'h4'} sx={{ fontWeight: 700, color: theme.palette.text.secondary, mb: 2 }}>
            More Clarity.
          </Typography>
    ...
    <Paper elevation={0} sx={{backgroundColor: 'whitesmoke', minHeight: '50vh', display: 'flex', textAlign: 'center', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', paddingBottom: {xs: 0, md: 8}}}>
        <Typography component="h3" variant={isMd ? 'h3' : 'h4'} sx={{margin: 3, color: theme.clarity.secondary, fontWeight: 700 }}>
          Why Clarity?
        </Typography>
        <Typography variant="body1" sx={{ color: theme.palette.text.primary, maxWidth: '80vw', mb: 2 }}>
          Take back control of your attention and time, so you can focus on more important things.
        </Typography>
        <Grid container spacing={2} justifyContent="center" alignItems="stretch" width="80%">
          <WhyItem
            ...
            text="There is so much to do and so little time, so why waste that time on social media. Block it out, and find more time for yourself."
            theme={theme}
          />
          <WhyItem
            ...
            header="Cleaner Interface"
            text="Want to get rid of buttons you rarely use or stop sites from pestering you with suggestions? Clarity can hide elements as you wish so you can enjoy a cleaner user interface."
            theme={theme}
          />
          <WhyItem
            ...
            header="Sustainable Solution"
            text="Uninstalling social media apps is not a practical solution for most people. Clarity provides a sustainable way to manage your social media usage."
            theme={theme}
        />
          <WhyItem
        ...
        />
          <WhyItem
            ...
            header="Wide Compatibility"
            text="Built for every Chromium based browsers such as Chrome, Edge, Brave, etc. With support for Facebook, Twitch, Twitter, and YouTube."
            theme={theme}
          />
          <WhyItem
