  ...
  return (
    <Grid item sx={12} sm={6} md={4} display="flex" justifyContent="center">
      <Paper elevation={0} sx={{ p: 3, backgroundColor: 'whitesmoke', display: 'flex', flexDirection: 'column', alignItems: 'center', width: '70vw' }}>
        <Box sx={{ mb: 2, width: 48, height: 48, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          {svg}
        </Box>
...
function Clarity() {
  ...
  return (
    <Box>
      ...
      <Paper sx={{backgroundColor: 'whitesmoke', minHeight: '50vh', display: 'flex', textAlign: 'center', justifyContent: 'center', flexDirection: 'column'}}>
          ...
          <Grid container spacing={2} justifyContent="center" alignItems="stretch">
            <WhyItem
              ...
              header="Extensive Settings"
              text="Hundreds of settings allow for a customizable experience. A slider for quick, easy, and seamless configuration. "
            />
            <WhyItem
              ...
              header="Supports Multiple Browsers and Platforms"
